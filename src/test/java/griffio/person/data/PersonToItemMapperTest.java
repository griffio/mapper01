...
import griffio.person.DateOfBirth;
...
public class PersonToItemMapperTest {
  ...
  public void person_item_must_be_equivalent(String fullName, DateOfBirth dateOfBirth, Gender gender,
    ...
    assertThat(actual.getDateOfBirth().toString()).isEqualTo(expected.getDateOfBirth());
